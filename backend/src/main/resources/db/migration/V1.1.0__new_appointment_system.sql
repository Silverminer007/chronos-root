...
ALTER TABLE settings
    ADD COLUMN appointment_cancelled                    VARCHAR(255) NOT NULL DEFAULT 'ENABLED',
    ADD COLUMN appointment_message                      VARCHAR(255) NOT NULL DEFAULT 'ENABLED',
    ADD COLUMN appointment_moved                        VARCHAR(255) NOT NULL DEFAULT 'ENABLED',
    ADD COLUMN appointment_participant_added            VARCHAR(255) NOT NULL DEFAULT 'ENABLED',
    ADD COLUMN appointment_participation_invalid        VARCHAR(255) NOT NULL DEFAULT 'ENABLED',
    ADD COLUMN appointment_participation_status_changed VARCHAR(255) NOT NULL DEFAULT 'ENABLED',
    ADD COLUMN appointment_participation_status_pending VARCHAR(255) NOT NULL DEFAULT 'ENABLED',
    ADD COLUMN appointment_reminder                     VARCHAR(255) NOT NULL DEFAULT 'ENABLED',
    ADD COLUMN group_member_added                       VARCHAR(255) NOT NULL DEFAULT 'ENABLED';
