    ...
    actions: {
        async fetchFriends() {
            ...
            try {
                ...
                this.error = getErrorMessage(err, 'Fehler beim Laden der Freunde')
                throw err
            } finally {
                this.loading = false
            }
        ...
        async fetchIncomingRequests() {
            ...
            try {
                ...
                this.error = getErrorMessage(err, 'Fehler beim Laden der eingehenden Anfragen')
                throw err
            } finally {
                this.loading = false
            }
        ...
        async fetchOutgoingRequests() {
            ...
            try {
                ...
                this.error = getErrorMessage(err, 'Fehler beim Laden der ausgehenden Anfragen')
                throw err
            } finally {
                this.loading = false
            }
        ...
        async fetchAll() {
            ...
            try {
                ...
                this.error = getErrorMessage(err, 'Fehler beim Laden der Daten')
                throw err
            } finally {
                this.loading = false
            }
        ...
        async endFriendship(friendId: number) {
            try {
                ...
                this.error = getErrorMessage(err, 'Fehler beim Beenden der Freundschaft')
                throw err
            }
        },
        ...
        async sendRequest(email: string) {
            try {
                ...
                this.error = getErrorMessage(err, 'Fehler beim Senden der Anfrage')
                throw err
            }
        },
        ...
        async acceptRequest(requestId: number) {
            try {
                ...
                this.error = getErrorMessage(err, 'Fehler beim Annehmen der Anfrage')
                throw err
            }
        },
        ...
        async declineRequest(requestId: number) {
            try {
                ...
                this.error = getErrorMessage(err, 'Fehler beim Ablehnen der Anfrage')
                throw err
            }
        },
        ...
        async cancelRequest(requestId: number) {
            try {
                ...
                this.error = getErrorMessage(err, 'Fehler beim Zurückziehen der Anfrage')
                throw err
            }
        },
