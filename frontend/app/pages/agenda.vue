  ...
  <div class="min-h-screen bg-gray-50 dark:bg-neutral-900">
    ...
    <div class="container mx-auto px-4 sm:px-6 pt-24 pb-24">
      <div class="max-w-4xl mx-auto space-y-6">
        ...
        <!-- Error State -->
        <div v-if="eventStore.error" class="p-6 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl">
        ...
        <div v-if="!eventStore.loading && eventStore.events.length === 0 && !eventStore.error"
          ...
          <p class="text-gray-600 dark:text-gray-400 mb-6">Erstelle deinen ersten Termin oder warte auf eine Einladung.</p>
        </div>
