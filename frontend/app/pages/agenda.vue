  ...
  <div class="min-h-screen bg-gray-50 dark:bg-neutral-900">
    ...
    <div class="container mx-auto px-4 sm:px-6  pb-24">
      <div class="max-w-4xl mx-auto space-y-6">
        <!-- Appointment Cards -->
        <AppointmentCard v-for="appointment in appointmentsStore.appointments" :key="appointment.id" :appointment="appointment"/>

        <!-- Skeletons -->
        <AppointmentCardSkeleton v-if="appointmentsStore.loading" v-for="i in [1, 2, 3, 4, 5]" :key="i"/>

        <!-- Error State -->
        <div v-if="appointmentsStore.error"
        ...
        <!-- Empty State -->
        <div v-if="!appointmentsStore.loading && appointmentsStore.appointments.length === 0 && !appointmentsStore.error"
